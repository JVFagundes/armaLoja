...
<nav class="navbar">
    ...
    <a href="/"><img class="card-box"  src="akuma.png" width="300px" height="450px"></img></a>

<div class="center">        

<h1>Nome: Akuma (悪魔 ou アクマ, "Demon, Devil" em Japonês)
<br>

Terra Natal: Japão
<br>

Estilo de Luta: Desconhecida Arte Ansatsuken alimentada pelo Satsui no Hadou
<br>

Relativos: <br> Gouken (Irmão) <br> Ryu (Arquinimigo) <br> Goutetsu (Mestre)
</h1> 
