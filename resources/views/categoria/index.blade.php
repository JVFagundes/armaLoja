...
<h1>Lista categorias</h1>
    <div class="my-4">
    <a class="btn btn-dark" href="{{route('cat.create')}}">Adicionar nova categoria</a>
    </div>
    <br><br>
...
<ul class="list-group">
    ...
    <a class="btn btn-primary" href="{{route('cat.show', $categoria->id)}}">Ver categoria</a>
    <a class="btn btn-primary" href="{{route('cat.produto', $categoria->id)}}">Ver produtos desta categoria</a>
    <a class="btn btn-primary" href="{{route('cat.edit', $categoria->id)}}">Editar categoria</a>
    <form action="{{route('cat.destroy', $categoria->id)}}" method="POST">
    @csrf
    @method('DELETE')
